    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Congés/Détails</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="absence-card">
        <div class="absence-content">
            ...
            <div class="absence-info">
                <p><strong>Période:</strong> Du {{ date('d/m/Y', strtotime($conge->date_debut)) }} 
                   au {{ date('d/m/Y', strtotime($conge->date_fin)) }}</p>
                <p><strong>Durée:</strong> {{ $conge->duree }} jour(s)</p>
                <p><strong>Demande créée le:</strong> {{ $conge->created_at->format('d/m/Y') }}</p>
            </div>
            <div class="motif-section">
                <h6>Motif de l'absence:</h6>
                <p class="absence-description">{{ $conge->motif }}</p>
            </div>
