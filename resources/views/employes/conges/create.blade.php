...
@section('custom_page')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Congés/Nouvelle Demande</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <div class="Acontainer">
        <form class="Aform" action="{{ route('conges.store') }}" method="POST">
            @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            submitButton.addEventListener('click', function(e) {
                ...
                Swal.fire({
                    title: 'Voulez-vous soumettre cette demande de congé ?',
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire({
                            icon: "success",
                            title: "Demande de congé soumis avec succès",
